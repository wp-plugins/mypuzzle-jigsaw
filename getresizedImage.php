...
if (!isset($_GET["resizePath"])){$resizePath = "../jigsaw/img";} else {$resizePath = $_GET["resizePath"];}
if (!isset($_GET["maxWidth"])){$width = "640";} else {$width = $_GET["maxWidth"];}
if (!isset($_GET["maxHeight"])){$height = "440";} else {$height = $_GET["maxHeight"];}
