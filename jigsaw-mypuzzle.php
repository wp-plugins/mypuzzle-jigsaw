...
function jigsaw_mp($atts) {
	...
	extract(shortcode_atts(array(
        ...
        if (isset($atts['doredirect'])) $doRedirect = $atts['doredirect'];
        if (isset($atts['mylink'])) $myLink = $atts['mylink'];
	...
	$output .= "<param name='flashvars' value='myThumbnail=" . $preview . "&myRot=" . $rotation . "&myPieces=" . $pieces . "&myPic=" . $myPic . "&myRestart=" . $showRestart . "&myGallery=" . $showGallery . "&doRedirect=" . $doRedirect  . "&myLink=" . $myLink . "' />\r";
	...
	$output .= "<embed src='".$flash."' flashvars='myThumbnail=" . $preview . "&myRot=" . $rotation . "&myPieces=" . $pieces . "&myPic=" . $myPic . "&myRestart=" . $showRestart . "&myGallery=" . $showGallery . "&doRedirect=" . $doRedirect . "&myLink=" . $myLink . "' quality='high' bgcolor='#".$bgcolor."'  swLiveConnect='true' ";
	...
	$output .= "</object>\r";
        ...
        $output .= "<div id='var_doredirect_jigsaw' style='visibility:hidden;position:absolute'>".$doRedirect."</div>\r";
        $output .= "<div id='var_mylink_jigsaw' style='visibility:hidden;position:absolute'>".$myLink."</div>\r";
...
function jigsaw_mp_options_page() {
	...
	if(isset($_POST['Submit'])){
     		...
     		$newoptions['pieces'] = isset($_POST['pieces'])?$_POST['pieces']:$options['pieces'];
                ...
                $newoptions['doredirect'] = isset($_POST['doredirect'])?$_POST['doredirect']:$options['doredirect'];
                $newoptions['mylink'] = isset($_POST['mylink'])?$_POST['mylink']:$options['mylink'];
	...
	$pieces = $options['pieces'];
        ...
        if (!is_numeric($doresize) || !jigsaw_mp_testRange(intval($doresize),0,1)) {$doresize=0;}
        if (!is_numeric($doredirect) || !jigsaw_mp_testRange(intval($doredirect),0,1)) {$doredirect=0;}
	...
	<h3><?php _e("jigsaw Puzzle Parameters") ?></h3>
        ...
        <table width="" border="0" cellspacing="10" cellpadding="0">
            <tr>
                ...
                <td>
                    <input style="width: 200px" type="text" name="size" value="<?php echo ($size); ?>">
            ...
            <tr>
                ...
                <td>
                    <select name="pieces" id="pieces" style="width: 200px">
            ...
            <tr>
                ...
                <td>
                    <select name="rotation" id="rotation" style="width: 200px">
            ...
            <tr>
                ...
                <td>
                    <select name="preview" id="preview" style="width: 200px">
            ...
            <tr>
                ...
                <td>
                    <select name="showrestart" id="showrestart" style="width: 200px">
            ...
            <tr>
                ...
                <td>
                    <select name="showgallery" id="showgallery" style="width: 200px">
            ...
            <tr>
                ...
                <td>
                    <input style="width: 200px" type="text" name="bgcolor" value="<?php echo ($bgcolor); ?>">
                </td>
            ...
            <tr>
                ...
                <td>
                    <select name="doredirect" id="doredirect" style="width: 200px">
                            <option value="0"<?php echo ($doredirect == 0 ? " selected" : "") ?>><?php echo _e("Restart on solved") ?></option>
                            <option value="1"<?php echo ($doredirect == 1 ? " selected" : "") ?>><?php echo _e("Redirect on solved") ?></option>
                    </select>
                </td>
                <td width="500">
                    Enables a redirection to another page when the user has solved the puzzle
                </td>
            </tr>
            <tr>
                <td width="100">
                ...
                <td>
                    <input style="width: 200px" type="text" name="mylink" value="<?php echo ($mylink); ?>">
                </td>
                <td width="500">
                    Enter a URL starting with http:// to an URL where the user will be redirected to after solving the puzzle
                </td>
            </tr>
        </table>
